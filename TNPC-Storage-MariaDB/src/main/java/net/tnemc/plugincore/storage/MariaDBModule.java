 ...
 */
@ModuleInfo(
        name = "TNPC-Storage-MariaDB",
        author = "creatorfromhell",
        version = "2.0.0.0",
        minimumVersion = "2.0.0.0"
)
public class MariaDBModule implements Module {
  ...
  public void enable() {
    ...
    context.services().register(StorageFactory.class, "mariadb", new MariaDBFactory());
  }

  @Override
  public void disable() {

    context.services().unregister(StorageFactory.class, "mariadb");
  }
}