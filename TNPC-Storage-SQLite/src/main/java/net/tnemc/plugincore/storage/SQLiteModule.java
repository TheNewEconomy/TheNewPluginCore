 ...
 */
@ModuleInfo(
        name = "TNPC-Storage-SQLite",
        author = "creatorfromhell",
        version = "2.0.0.0",
        minimumVersion = "2.0.0.0"
)
public class SQLiteModule implements Module {
  ...
  public void enable() {
    ...
    context.services().register(StorageFactory.class, "sqlite", new SQLiteFactory());
  }

  @Override
  public void disable() {

    context.services().unregister(StorageFactory.class, "sqlite");
  }
}