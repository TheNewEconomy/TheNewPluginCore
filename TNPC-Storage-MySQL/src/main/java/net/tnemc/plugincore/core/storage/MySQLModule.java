 ...
 */
@ModuleInfo(
        name = "TNPC-Storage-MySQL",
        author = "creatorfromhell",
        version = "2.0.0.0",
        minimumVersion = "2.0.0.0"
)
public final class MySQLModule implements Module {
  ...
  public void enable() {
    ...
    context.services().register(StorageFactory.class, "mysql", new MySQLFactory());
  }

  @Override
  public void disable() {

    context.services().unregister(StorageFactory.class, "mysql");
  }
}