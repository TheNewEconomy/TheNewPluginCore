...
public class MongoDBModule implements Module {
  ...
  public void enable() {
    ...
    context.services().register(StorageFactory.class, "mongodb", new MongoDBFactory());
  }

  @Override
  public void disable() {

    context.services().unregister(StorageFactory.class, "mongodb");
  }
}