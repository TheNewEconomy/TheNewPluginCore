package net.tnemc.plugincore.api.scheduler;
/*
 * The New Plugin Core
...
public abstract class SchedulerProvider<C extends Chore<?>> {
   ...
   */
  public int createRepeatingTaskID(final Runnable task, final ChoreTime delay, final ChoreTime period, final ChoreExecution environment) {
