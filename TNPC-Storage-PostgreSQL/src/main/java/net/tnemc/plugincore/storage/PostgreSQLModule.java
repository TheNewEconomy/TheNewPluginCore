...
public class PostgreSQLModule implements Module {
  ...
  public void enable() {
    ...
    context.services().register(StorageFactory.class, "postgresql", new PostgreSQLFactory());
  }

  @Override
  public void disable() {

    context.services().unregister(StorageFactory.class, "postgresql");
  }
}