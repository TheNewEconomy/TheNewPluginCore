...
public class CoreWorldConnectionProvider implements WorldConnectionProvider {
   ...
   */
  @Override
  public String resolveWorld(String world, String connectionType) {
    return null;
  }
   ...
   */
  @Override
  public String resolveWorld(Player player) {
    return null;
  }
   ...
   */
  @Override
  public String resolveWorld(Player player, String connectionType) {
    return null;
  }
}